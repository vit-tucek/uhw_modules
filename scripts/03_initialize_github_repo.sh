...
git remote add origin https://github.com/vit-tucek/uhw_modules.git >> install.log
...
git clone --single-branch --depth 1 https://github.com/vit-tucek/uhw_modules.git gh-pages >> install.log
cd gh-pages
